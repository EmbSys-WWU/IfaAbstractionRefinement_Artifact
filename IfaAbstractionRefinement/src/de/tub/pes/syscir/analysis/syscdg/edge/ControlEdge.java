...
/**
 * This class represents an Control Edge.
 * 
 * @author Jan Maria Kirchner
 */
public class ControlEdge<N extends Node<S, ND>, M extends Node<S, ND>, S extends SecurityLevel<S>, ED extends EdgeData, ND extends NodeData>
        extends Edge<N, M, S, ED, ND> {

    /**
     * The constructor of the ControlEdge.
     * 
     * @param ED The edge data of the edge
     * @param N The source node of the edge
     * @param M The target node of the edge
     */
    public ControlEdge(ED edgeData, N sourceNode, M targetNode) {
