...
/**
 * The ControlNode class represents a control node in the SDG.
 *
 * @author Jan Maria Kirchner
 */
public class ControlNode<S extends SecurityLevel<S>, ND extends NodeData> extends Node<S, ND> {

    /**
     * The constructor for the ControlNode.
     *
     ...
     */
    public ControlNode(ND nodeData, S providedSecurityLevel, S requiredSecurityLevel, boolean declassification) {
