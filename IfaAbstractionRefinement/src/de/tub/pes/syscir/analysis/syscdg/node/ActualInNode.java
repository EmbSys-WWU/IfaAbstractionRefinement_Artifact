...
/**
 * This class represents an actual-in node. It is also summary node.
 *
 * @author Jan Maria Kirchner
 */
public class ActualInNode<S extends SecurityLevel<S>, ND extends NodeData> extends SummaryNode<S, ND> {

    /**
     * The constructor for the ActualInNode.
     *
     ...
     */
    public ActualInNode(ND nodeData, S providedSecurityLevel, S requiredSecurityLevel, boolean declassification) {
