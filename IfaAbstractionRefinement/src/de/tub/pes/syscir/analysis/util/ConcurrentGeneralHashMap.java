...
/**
 * A hash table with adjustable hash function and equality, supporting full concurrency of
 * retrievals and adjustable expected concurrency for updates. This class obeys the same functional
 * specification as {@link java.util.Hashtable} (except for the adjustable hash function and
 * equality), and includes versions of methods corresponding to each method of <tt>Hashtable</tt>.
 * However, even though all operations are thread-safe, retrieval operations do <em>not</em> entail
 * locking, and there is <em>not</em> any support for locking the entire table in a way that
 * prevents all access. This class is fully interoperable with <tt>Hashtable</tt> in programs that
 * rely on its thread safety but not on its synchronization details.
 * 
 * <p>
 * The hash function and equality relation used by this map can be specified in the constructor.
 ...
 *
 * @author Jonas Becker-Kupczok, modified from Doug Lea
 * @param <K> the type of keys maintained by this map
 * @param <V> the type of mapped values
 */
public class ConcurrentGeneralHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /**
     * ConcurrentGeneralHashMap list entry. Note that this is never exported out as a user-visible
     * Map.Entry.
     *
    ...
    final Segment[] newSegmentArray(int i) {
        return new ConcurrentGeneralHashMap.Segment[i];
    }
    ...
    final class Segment extends ReentrantLock {
        ...
        V get(Object key, int hash) {
            if (this.count != 0) { // read-volatile
                ...
                while (e != null) {
                    if (e.hash == hash && areEqualKeys(e.key, key)) {
                        V v = e.value;
                        if (v != null) {
                            return v;
                        }
        ...
        boolean replace(K key, int hash, V oldValue, V newValue) {
            ...
            try {
                HashEntry<K, V> e = getFirst(hash);
                while (e != null && (e.hash != hash || !areEqualKeys(e.key, key))) {
                    e = e.next;
                }
                
                boolean replaced = false;
                if (e != null && areEqualValues(oldValue, e.value)) {
                    replaced = true;
                    e.value = newValue;
                }
                return replaced;
        ...
        V remove(Object key, int hash, Object value) {
            ...
            try {
                ...
                if (e != null) {
                    V v = e.value;
                    if (value == null || areEqualValues(v, value)) {
                        oldValue = v;
     ...
     */
    public ConcurrentGeneralHashMap(ToIntFunction<? super K> hasher, BiPredicate<? super K, ? super K> equality,
        ...
        this.segments = newSegmentArray(ssize);
    ...
    public ConcurrentGeneralHashMap(ToIntFunction<? super K> hasher, BiPredicate<? super K, ? super K> equality,
            int initialCapacity) {
        this(hasher, equality, initialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
    }
     ...
     */
    public ConcurrentGeneralHashMap(ToIntFunction<? super K> hasher, BiPredicate<? super K, ? super K> equality) {
        this(hasher, equality, DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
    }
    ...
    public ConcurrentGeneralHashMap(ToIntFunction<? super K> hasher, BiPredicate<? super K, ? super K> equality,
        ...
        this(hasher, equality, Math.max((int) (m.size() / DEFAULT_LOAD_FACTOR) + 1, DEFAULT_INITIAL_CAPACITY),
                DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
        putAll(m);
    }
    
    public ConcurrentGeneralHashMap(ConcurrentGeneralHashMap<K, V> m) {
        this(m.hasher, m.equality, Math.max((int) (m.size() / DEFAULT_LOAD_FACTOR) + 1, DEFAULT_INITIAL_CAPACITY),
                DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
        putAll(m);
    }
    ...
    public V get(Object key) {
        int hash = computeHashCode(key.hashCode());
    ...
    abstract class HashIterator {
        ...
        HashIterator() {
            this.nextSegmentIndex = ConcurrentGeneralHashMap.this.segments.length - 1;
        ...
        final void advance() {
            ...
            while (this.nextSegmentIndex >= 0) {
                Segment seg = ConcurrentGeneralHashMap.this.segments[this.nextSegmentIndex--];
                if (seg.count != 0) {
        ...
        public void remove() {
            ...
            ConcurrentGeneralHashMap.this.remove(this.lastReturned.key);
    ...
    final class WriteThroughEntry extends SimpleEntry {
        ...
        public V setValue(V value) {
            ...
            ConcurrentGeneralHashMap.this.put(getKey(), value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        @Override
        public int size() {
            return ConcurrentGeneralHashMap.this.size();
        }
        
        @Override
        public boolean isEmpty() {
            return ConcurrentGeneralHashMap.this.isEmpty();
        }
        
        @Override
        public boolean contains(Object o) {
            return ConcurrentGeneralHashMap.this.containsKey(o);
        }
        
        @Override
        public boolean remove(Object o) {
            return ConcurrentGeneralHashMap.this.remove(o) != null;
        }
        
        @Override
        public void clear() {
            ConcurrentGeneralHashMap.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ConcurrentGeneralHashMap.this.containsValue(o);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = ConcurrentGeneralHashMap.this.get(e.getKey());
            return v != null && areEqualValues(v, e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            Map.Entry<?, ?> e = (Map.Entry<?, ?>) o;
            return ConcurrentGeneralHashMap.this.remove(e.getKey(), e.getValue());
        }
    ...
    class SimpleEntry implements Entry<K, V> {
        ...
        public boolean equals(Object o) {
            ...
            return areEqualKeys(this.key, e.getKey()) && areEqualValues(this.value, e.getValue());
        }
    ...
    /**
     * Save the state of the <tt>ConcurrentGeneralHashMap</tt> instance to a stream (i.e., serialize
     * it).
     *
     * @param s the stream
    ...
    /**
     * Reconstitute the <tt>ConcurrentGeneralHashMap</tt> instance from a stream (i.e., deserialize it).
     *
     * @param s the stream
     */
