 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTtype_specifier.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTtype_specifier extends SimpleNode {
  public ASTtype_specifier(int id) {
    super(id);
  }

  public ASTtype_specifier(SCParser p, int id) {
    super(p, id);
  }
