 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTclass_or_namespace_name.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTclass_or_namespace_name extends SimpleNode {
  public ASTclass_or_namespace_name(int id) {
    super(id);
  }

  public ASTclass_or_namespace_name(SCParser p, int id) {
    super(p, id);
  }
