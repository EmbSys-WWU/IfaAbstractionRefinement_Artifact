 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_thread_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_thread_block extends SimpleNode {
  public ASTsc_thread_block(int id) {
    super(id);
  }

  public ASTsc_thread_block(SCParser p, int id) {
    super(p, id);
  }
