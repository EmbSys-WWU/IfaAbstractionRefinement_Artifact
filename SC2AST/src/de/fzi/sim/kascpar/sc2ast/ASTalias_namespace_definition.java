 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTalias_namespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTalias_namespace_definition extends SimpleNode {
  public ASTalias_namespace_definition(int id) {
    super(id);
  }

  public ASTalias_namespace_definition(SCParser p, int id) {
    super(p, id);
  }
