 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsystemCRoutine.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsystemCRoutine extends SimpleNode {
  public ASTsystemCRoutine(int id) {
    super(id);
  }

  public ASTsystemCRoutine(SCParser p, int id) {
    super(p, id);
  }
