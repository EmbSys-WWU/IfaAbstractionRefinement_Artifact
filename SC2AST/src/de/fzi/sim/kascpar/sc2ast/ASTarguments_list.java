 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTarguments_list.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTarguments_list extends SimpleNode {
  public ASTarguments_list(int id) {
    super(id);
  }

  public ASTarguments_list(SCParser p, int id) {
    super(p, id);
  }
