 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTadd_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTadd_node extends SimpleNode {
  public ASTadd_node(int id) {
    super(id);
  }

  public ASTadd_node(SCParser p, int id) {
    super(p, id);
  }
