 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnamespace_qualified_spec.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnamespace_qualified_spec extends SimpleNode {
  public ASTnamespace_qualified_spec(int id) {
    super(id);
  }

  public ASTnamespace_qualified_spec(SCParser p, int id) {
    super(p, id);
  }
