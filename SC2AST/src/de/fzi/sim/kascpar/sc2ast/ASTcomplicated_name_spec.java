 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTcomplicated_name_spec.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTcomplicated_name_spec extends SimpleNode {
  public ASTcomplicated_name_spec(int id) {
    super(id);
  }

  public ASTcomplicated_name_spec(SCParser p, int id) {
    super(p, id);
  }
