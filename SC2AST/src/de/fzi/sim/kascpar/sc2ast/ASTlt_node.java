 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTlt_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTlt_node extends SimpleNode {
  public ASTlt_node(int id) {
    super(id);
  }

  public ASTlt_node(SCParser p, int id) {
    super(p, id);
  }
