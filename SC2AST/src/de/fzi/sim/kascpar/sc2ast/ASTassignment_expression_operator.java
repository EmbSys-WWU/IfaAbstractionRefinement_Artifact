 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTassignment_expression_operator.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTassignment_expression_operator extends SimpleNode {
  public ASTassignment_expression_operator(int id) {
    super(id);
  }

  public ASTassignment_expression_operator(SCParser p, int id) {
    super(p, id);
  }
