 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTdyn_process_creation_block_declaration.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTdyn_process_creation_block_declaration extends SimpleNode {
  public ASTdyn_process_creation_block_declaration(int id) {
    super(id);
  }

  public ASTdyn_process_creation_block_declaration(SCParser p, int id) {
    super(p, id);
  }
