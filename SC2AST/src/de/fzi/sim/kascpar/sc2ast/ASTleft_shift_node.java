 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTleft_shift_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTleft_shift_node extends SimpleNode {
  public ASTleft_shift_node(int id) {
    super(id);
  }

  public ASTleft_shift_node(SCParser p, int id) {
    super(p, id);
  }
