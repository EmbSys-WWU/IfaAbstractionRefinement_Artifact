...
public class ASTclass_specifier extends SimpleNode {
  public ASTclass_specifier(int id) {
    super(id);
    setExtOfSCClass(false);
  }

  public ASTclass_specifier(SCParser p, int id) {
    super(p, id);
    setExtOfSCClass(false);
  }
  ...
  */
  ...
  protected boolean m_extOfSCClass;
  protected String m_keyword;
  

  public void setExtOfSCClass(boolean b) {
    m_extOfSCClass = b;
  }

  public boolean extOfSCClass() {
    return m_extOfSCClass;
  }
