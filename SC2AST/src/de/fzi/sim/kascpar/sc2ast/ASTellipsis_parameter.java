 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTellipsis_parameter.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTellipsis_parameter extends SimpleNode {
  public ASTellipsis_parameter(int id) {
    super(id);
  }

  public ASTellipsis_parameter(SCParser p, int id) {
    super(p, id);
  }
