 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTswitch_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTswitch_statement extends SimpleNode {
  public ASTswitch_statement(int id) {
    super(id);
  }

  public ASTswitch_statement(SCParser p, int id) {
    super(p, id);
  }
