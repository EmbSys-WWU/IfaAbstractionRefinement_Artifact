 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTdereferencing_operator.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTdereferencing_operator extends SimpleNode {
  public ASTdereferencing_operator(int id) {
    super(id);
  }

  public ASTdereferencing_operator(SCParser p, int id) {
    super(p, id);
  }
