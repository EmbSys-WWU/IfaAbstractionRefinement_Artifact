 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTextended_namespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTextended_namespace_definition extends SimpleNode {
  public ASTextended_namespace_definition(int id) {
    super(id);
  }

  public ASTextended_namespace_definition(SCParser p, int id) {
    super(p, id);
  }
