 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTarrayaccess_expression.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTarrayaccess_expression extends SimpleNode {
  public ASTarrayaccess_expression(int id) {
    super(id);
  }

  public ASTarrayaccess_expression(SCParser p, int id) {
    super(p, id);
  }
