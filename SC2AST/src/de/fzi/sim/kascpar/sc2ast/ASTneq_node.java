 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTneq_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTneq_node extends SimpleNode {
  public ASTneq_node(int id) {
    super(id);
  }

  public ASTneq_node(SCParser p, int id) {
    super(p, id);
  }
