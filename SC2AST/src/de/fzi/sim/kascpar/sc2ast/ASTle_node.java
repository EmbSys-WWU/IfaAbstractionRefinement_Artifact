 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTle_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTle_node extends SimpleNode {
  public ASTle_node(int id) {
    super(id);
  }

  public ASTle_node(SCParser p, int id) {
    super(p, id);
  }
