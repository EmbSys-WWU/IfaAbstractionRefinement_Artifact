 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTstatement_expression_list.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTstatement_expression_list extends SimpleNode {
  public ASTstatement_expression_list(int id) {
    super(id);
  }

  public ASTstatement_expression_list(SCParser p, int id) {
    super(p, id);
  }
