...
public class ASTm_s_protocol_declaration extends SimpleNode {
  public ASTm_s_protocol_declaration(int id) {
    super(id);
    setRange(0);
  }

  public ASTm_s_protocol_declaration(SCParser p, int id) {
    super(p, id);
    setRange(0);    
  }
