 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTfor_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTfor_statement extends SimpleNode {
  public ASTfor_statement(int id) {
    super(id);
  }

  public ASTfor_statement(SCParser p, int id) {
    super(p, id);
  }
