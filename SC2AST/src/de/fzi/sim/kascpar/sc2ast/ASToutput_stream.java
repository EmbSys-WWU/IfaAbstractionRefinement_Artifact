 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASToutput_stream.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASToutput_stream extends SimpleNode {
  public ASToutput_stream(int id) {
    super(id);
  }

  public ASToutput_stream(SCParser p, int id) {
    super(p, id);
  }
