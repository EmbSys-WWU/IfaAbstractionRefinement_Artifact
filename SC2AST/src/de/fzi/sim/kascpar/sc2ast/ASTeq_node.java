 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTeq_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTeq_node extends SimpleNode {
  public ASTeq_node(int id) {
    super(id);
  }

  public ASTeq_node(SCParser p, int id) {
    super(p, id);
  }
