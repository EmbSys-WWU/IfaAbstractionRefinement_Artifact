 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTusing_declaration.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTusing_declaration extends SimpleNode {
  public ASTusing_declaration(int id) {
    super(id);
  }

  public ASTusing_declaration(SCParser p, int id) {
    super(p, id);
  }
