 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTexpression_assignment.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTexpression_assignment extends SimpleNode {
  public ASTexpression_assignment(int id) {
    super(id);
  }

  public ASTexpression_assignment(SCParser p, int id) {
    super(p, id);
  }
