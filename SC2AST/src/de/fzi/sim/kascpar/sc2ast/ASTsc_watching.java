 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_watching.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_watching extends SimpleNode {
  public ASTsc_watching(int id) {
    super(id);
  }

  public ASTsc_watching(SCParser p, int id) {
    super(p, id);
  }
