 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnot_qualified_id.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnot_qualified_id extends SimpleNode {
  public ASTnot_qualified_id(int id) {
    super(id);
  }

  public ASTnot_qualified_id(SCParser p, int id) {
    super(p, id);
  }
