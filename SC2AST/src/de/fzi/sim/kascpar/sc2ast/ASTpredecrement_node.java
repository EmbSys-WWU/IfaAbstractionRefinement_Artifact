 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTpredecrement_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTpredecrement_node extends SimpleNode {
  public ASTpredecrement_node(int id) {
    super(id);
  }

  public ASTpredecrement_node(SCParser p, int id) {
    super(p, id);
  }
