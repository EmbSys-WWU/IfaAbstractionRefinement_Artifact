 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTpostdecrement_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTpostdecrement_node extends SimpleNode {
  public ASTpostdecrement_node(int id) {
    super(id);
  }

  public ASTpostdecrement_node(SCParser p, int id) {
    super(p, id);
  }
