 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnamespace_body.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnamespace_body extends SimpleNode {
  public ASTnamespace_body(int id) {
    super(id);
  }

  public ASTnamespace_body(SCParser p, int id) {
    super(p, id);
  }
