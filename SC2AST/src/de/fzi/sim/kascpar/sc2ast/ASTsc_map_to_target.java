...
public class ASTsc_map_to_target extends SimpleNode {
  public ASTsc_map_to_target(int id) {
    super(id);
  }
  ...
  */
  ...
  // variable(s)
  String m_obj, m_target, m_instId;
  ...
  */
  ...
  public ASTsc_map_to_target(SCParser p, int id) {
    super(p, id);
  }
