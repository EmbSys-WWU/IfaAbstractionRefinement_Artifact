 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASToptor_overloading.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASToptor_overloading extends SimpleNode {
  public ASToptor_overloading(int id) {
    super(id);
  }

  public ASToptor_overloading(SCParser p, int id) {
    super(p, id);
  }
