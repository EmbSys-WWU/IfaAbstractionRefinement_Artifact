 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTusing_directive.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTusing_directive extends SimpleNode {
  public ASTusing_directive(int id) {
    super(id);
  }

  public ASTusing_directive(SCParser p, int id) {
    super(p, id);
  }
