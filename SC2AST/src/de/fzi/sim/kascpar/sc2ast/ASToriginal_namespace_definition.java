 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASToriginal_namespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASToriginal_namespace_definition extends SimpleNode {
  public ASToriginal_namespace_definition(int id) {
    super(id);
  }

  public ASToriginal_namespace_definition(SCParser p, int id) {
    super(p, id);
  }
