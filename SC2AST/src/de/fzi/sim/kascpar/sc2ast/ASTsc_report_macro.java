 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_report_macro.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_report_macro extends SimpleNode {
  public ASTsc_report_macro(int id) {
    super(id);
  }

  public ASTsc_report_macro(SCParser p, int id) {
    super(p, id);
  }
