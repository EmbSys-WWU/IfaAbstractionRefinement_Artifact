 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTgt_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTgt_node extends SimpleNode {
  public ASTgt_node(int id) {
    super(id);
  }

  public ASTgt_node(SCParser p, int id) {
    super(p, id);
  }
