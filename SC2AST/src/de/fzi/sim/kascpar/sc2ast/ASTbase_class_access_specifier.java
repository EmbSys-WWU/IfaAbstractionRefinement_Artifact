 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTbase_class_access_specifier.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTbase_class_access_specifier extends SimpleNode {
  public ASTbase_class_access_specifier(int id) {
    super(id);
  }

  public ASTbase_class_access_specifier(SCParser p, int id) {
    super(p, id);
  }
