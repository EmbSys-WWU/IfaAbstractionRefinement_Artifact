 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTstandart_manipulator.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTstandart_manipulator extends SimpleNode {
  public ASTstandart_manipulator(int id) {
    super(id);
  }

  public ASTstandart_manipulator(SCParser p, int id) {
    super(p, id);
  }
