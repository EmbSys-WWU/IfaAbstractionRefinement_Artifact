 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTge_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTge_node extends SimpleNode {
  public ASTge_node(int id) {
    super(id);
  }

  public ASTge_node(SCParser p, int id) {
    super(p, id);
  }
