 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTpreprocessor_directive.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTpreprocessor_directive extends SimpleNode {
  public ASTpreprocessor_directive(int id) {
    super(id);
  }

  public ASTpreprocessor_directive(SCParser p, int id) {
    super(p, id);
  }
