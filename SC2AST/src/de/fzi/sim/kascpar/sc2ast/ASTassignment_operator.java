 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTassignment_operator.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTassignment_operator extends SimpleNode {
  public ASTassignment_operator(int id) {
    super(id);
  }

  public ASTassignment_operator(SCParser p, int id) {
    super(p, id);
  }
