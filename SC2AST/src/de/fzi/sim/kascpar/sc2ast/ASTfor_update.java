 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTfor_update.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTfor_update extends SimpleNode {
  public ASTfor_update(int id) {
    super(id);
  }

  public ASTfor_update(SCParser p, int id) {
    super(p, id);
  }
