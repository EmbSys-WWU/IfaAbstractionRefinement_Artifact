 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsizeof_expression.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsizeof_expression extends SimpleNode {
  public ASTsizeof_expression(int id) {
    super(id);
  }

  public ASTsizeof_expression(SCParser p, int id) {
    super(p, id);
  }
