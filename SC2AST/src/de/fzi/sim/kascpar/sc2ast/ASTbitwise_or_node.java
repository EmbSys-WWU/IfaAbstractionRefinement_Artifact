 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTbitwise_or_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTbitwise_or_node extends SimpleNode {
  public ASTbitwise_or_node(int id) {
    super(id);
  }

  public ASTbitwise_or_node(SCParser p, int id) {
    super(p, id);
  }
