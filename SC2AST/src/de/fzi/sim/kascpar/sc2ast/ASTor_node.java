 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTor_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTor_node extends SimpleNode {
  public ASTor_node(int id) {
    super(id);
  }

  public ASTor_node(SCParser p, int id) {
    super(p, id);
  }
