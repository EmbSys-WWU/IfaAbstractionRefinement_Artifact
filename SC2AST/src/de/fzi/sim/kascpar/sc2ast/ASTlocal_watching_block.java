 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTlocal_watching_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTlocal_watching_block extends SimpleNode {
  public ASTlocal_watching_block(int id) {
    super(id);
  }

  public ASTlocal_watching_block(SCParser p, int id) {
    super(p, id);
  }
