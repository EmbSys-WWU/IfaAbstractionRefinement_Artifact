 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTbitwise_and_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTbitwise_and_node extends SimpleNode {
  public ASTbitwise_and_node(int id) {
    super(id);
  }

  public ASTbitwise_and_node(SCParser p, int id) {
    super(p, id);
  }
