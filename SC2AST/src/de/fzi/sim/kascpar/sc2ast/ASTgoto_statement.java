 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTgoto_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTgoto_statement extends SimpleNode {
  public ASTgoto_statement(int id) {
    super(id);
  }

  public ASTgoto_statement(SCParser p, int id) {
    super(p, id);
  }
