 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_main_declaration.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_main_declaration extends SimpleNode {
  public ASTsc_main_declaration(int id) {
    super(id);
  }

  public ASTsc_main_declaration(SCParser p, int id) {
    super(p, id);
  }
