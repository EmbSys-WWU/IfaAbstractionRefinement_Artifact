 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTarray_initializer.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTarray_initializer extends SimpleNode {
  public ASTarray_initializer(int id) {
    super(id);
  }

  public ASTarray_initializer(SCParser p, int id) {
    super(p, id);
  }
