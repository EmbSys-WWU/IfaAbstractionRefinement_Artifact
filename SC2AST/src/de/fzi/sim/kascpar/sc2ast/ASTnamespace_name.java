 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnamespace_name.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnamespace_name extends SimpleNode {
  public ASTnamespace_name(int id) {
    super(id);
  }

  public ASTnamespace_name(SCParser p, int id) {
    super(p, id);
  }
