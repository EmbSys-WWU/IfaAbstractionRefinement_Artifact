 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTpreincrement_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTpreincrement_node extends SimpleNode {
  public ASTpreincrement_node(int id) {
    super(id);
  }

  public ASTpreincrement_node(SCParser p, int id) {
    super(p, id);
  }
