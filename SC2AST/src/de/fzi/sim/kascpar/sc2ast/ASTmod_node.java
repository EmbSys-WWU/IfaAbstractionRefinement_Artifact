 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTmod_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTmod_node extends SimpleNode {
  public ASTmod_node(int id) {
    super(id);
  }

  public ASTmod_node(SCParser p, int id) {
    super(p, id);
  }
