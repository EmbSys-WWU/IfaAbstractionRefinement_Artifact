 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_map_to_target_declaration.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_map_to_target_declaration extends SimpleNode {
  public ASTsc_map_to_target_declaration(int id) {
    super(id);
  }

  public ASTsc_map_to_target_declaration(SCParser p, int id) {
    super(p, id);
  }
