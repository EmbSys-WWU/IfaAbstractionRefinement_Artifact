 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASToriginal_namespace_name.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASToriginal_namespace_name extends SimpleNode {
  public ASToriginal_namespace_name(int id) {
    super(id);
  }

  public ASToriginal_namespace_name(SCParser p, int id) {
    super(p, id);
  }
