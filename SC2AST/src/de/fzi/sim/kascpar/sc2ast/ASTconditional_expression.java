...
public class ASTconditional_expression extends SimpleNode {
  public ASTconditional_expression(int id) {
    super(id);
    setIsQuestionmarkExpression(false);
    
  }

  public ASTconditional_expression(SCParser p, int id) {
    super(p, id);
    setIsQuestionmarkExpression(false);
  }
  ...
  */
  ...
  // variable(s)
  boolean m_isQuestionmark;

  public void setIsQuestionmarkExpression(boolean Questionmark) {
    m_isQuestionmark = Questionmark;
  }

  public boolean isQuestionmarkExpression() {
    return m_isQuestionmark;
  }
