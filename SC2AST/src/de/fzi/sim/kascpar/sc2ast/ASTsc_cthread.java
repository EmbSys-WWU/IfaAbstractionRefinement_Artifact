...
public class ASTsc_cthread extends SimpleNode {
  public ASTsc_cthread(int id) {
    super(id);
  }

  public ASTsc_cthread(SCParser p, int id) {
    super(p, id);
  }
  ...
  */
  ...
  // variable(s)
  protected String m_clock, m_edge;
