 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTquestionmark_expression.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTquestionmark_expression extends SimpleNode {
  public ASTquestionmark_expression(int id) {
    super(id);
  }

  public ASTquestionmark_expression(SCParser p, int id) {
    super(p, id);
  }
