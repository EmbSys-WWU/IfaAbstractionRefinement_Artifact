 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTmul_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTmul_node extends SimpleNode {
  public ASTmul_node(int id) {
    super(id);
  }

  public ASTmul_node(SCParser p, int id) {
    super(p, id);
  }
