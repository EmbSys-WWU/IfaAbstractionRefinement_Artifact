 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTunnamed_namespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTunnamed_namespace_definition extends SimpleNode {
  public ASTunnamed_namespace_definition(int id) {
    super(id);
  }

  public ASTunnamed_namespace_definition(SCParser p, int id) {
    super(p, id);
  }
