 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTdo_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTdo_statement extends SimpleNode {
  public ASTdo_statement(int id) {
    super(id);
  }

  public ASTdo_statement(SCParser p, int id) {
    super(p, id);
  }
