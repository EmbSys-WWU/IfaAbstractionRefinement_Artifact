 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTalias_namespace_name.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTalias_namespace_name extends SimpleNode {
  public ASTalias_namespace_name(int id) {
    super(id);
  }

  public ASTalias_namespace_name(SCParser p, int id) {
    super(p, id);
  }
