 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_watching_list.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_watching_list extends SimpleNode {
  public ASTsc_watching_list(int id) {
    super(id);
  }

  public ASTsc_watching_list(SCParser p, int id) {
    super(p, id);
  }
