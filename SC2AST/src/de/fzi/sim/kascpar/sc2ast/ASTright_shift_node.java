 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTright_shift_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTright_shift_node extends SimpleNode {
  public ASTright_shift_node(int id) {
    super(id);
  }

  public ASTright_shift_node(SCParser p, int id) {
    super(p, id);
  }
