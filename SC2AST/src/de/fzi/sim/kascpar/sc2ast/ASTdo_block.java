 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTdo_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTdo_block extends SimpleNode {
  public ASTdo_block(int id) {
    super(id);
  }

  public ASTdo_block(SCParser p, int id) {
    super(p, id);
  }
