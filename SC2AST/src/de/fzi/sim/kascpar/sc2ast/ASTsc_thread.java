 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_thread.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_thread extends SimpleNode {
  public ASTsc_thread(int id) {
    super(id);
  }

  public ASTsc_thread(SCParser p, int id) {
    super(p, id);
  }
