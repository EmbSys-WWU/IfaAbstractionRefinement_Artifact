...
public class ASTsc_slave extends SimpleNode {
  public ASTsc_slave(int id) {
    super(id);
  }

  public ASTsc_slave(SCParser p, int id) {
    super(p, id);
  }
