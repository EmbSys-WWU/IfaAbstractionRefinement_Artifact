 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTthis_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTthis_node extends SimpleNode {
  public ASTthis_node(int id) {
    super(id);
  }

  public ASTthis_node(SCParser p, int id) {
    super(p, id);
  }
