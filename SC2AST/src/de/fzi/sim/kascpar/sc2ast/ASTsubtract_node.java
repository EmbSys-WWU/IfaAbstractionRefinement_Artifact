 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsubtract_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsubtract_node extends SimpleNode {
  public ASTsubtract_node(int id) {
    super(id);
  }

  public ASTsubtract_node(SCParser p, int id) {
    super(p, id);
  }
