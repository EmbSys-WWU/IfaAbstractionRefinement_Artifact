 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_sensitive.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_sensitive extends SimpleNode {
  public ASTsc_sensitive(int id) {
    super(id);
  }

  public ASTsc_sensitive(SCParser p, int id) {
    super(p, id);
  }
