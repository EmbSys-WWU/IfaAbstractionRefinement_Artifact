 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTdiv_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTdiv_node extends SimpleNode {
  public ASTdiv_node(int id) {
    super(id);
  }

  public ASTdiv_node(SCParser p, int id) {
    super(p, id);
  }
