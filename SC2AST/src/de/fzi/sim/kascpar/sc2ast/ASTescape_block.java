 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTescape_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTescape_block extends SimpleNode {
  public ASTescape_block(int id) {
    super(id);
  }

  public ASTescape_block(SCParser p, int id) {
    super(p, id);
  }
