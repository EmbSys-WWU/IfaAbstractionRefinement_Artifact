 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTbitwise_xor_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTbitwise_xor_node extends SimpleNode {
  public ASTbitwise_xor_node(int id) {
    super(id);
  }

  public ASTbitwise_xor_node(SCParser p, int id) {
    super(p, id);
  }
