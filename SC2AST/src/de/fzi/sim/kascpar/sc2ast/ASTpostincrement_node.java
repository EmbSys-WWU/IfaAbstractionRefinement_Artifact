 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTpostincrement_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTpostincrement_node extends SimpleNode {
  public ASTpostincrement_node(int id) {
    super(id);
  }

  public ASTpostincrement_node(SCParser p, int id) {
    super(p, id);
  }
