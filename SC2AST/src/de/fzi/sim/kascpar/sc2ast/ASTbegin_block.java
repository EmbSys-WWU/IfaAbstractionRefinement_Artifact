 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTbegin_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTbegin_block extends SimpleNode {
  public ASTbegin_block(int id) {
    super(id);
  }

  public ASTbegin_block(SCParser p, int id) {
    super(p, id);
  }
