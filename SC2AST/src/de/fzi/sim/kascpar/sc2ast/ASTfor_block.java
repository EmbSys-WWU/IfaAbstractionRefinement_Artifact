 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTfor_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTfor_block extends SimpleNode {
  public ASTfor_block(int id) {
    super(id);
  }

  public ASTfor_block(SCParser p, int id) {
    super(p, id);
  }
