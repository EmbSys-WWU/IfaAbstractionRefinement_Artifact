 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTand_node.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTand_node extends SimpleNode {
  public ASTand_node(int id) {
    super(id);
  }

  public ASTand_node(SCParser p, int id) {
    super(p, id);
  }
