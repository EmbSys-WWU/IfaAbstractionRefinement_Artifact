 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTswitch_label.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTswitch_label extends SimpleNode {
  public ASTswitch_label(int id) {
    super(id);
  }

  public ASTswitch_label(SCParser p, int id) {
    super(p, id);
  }
