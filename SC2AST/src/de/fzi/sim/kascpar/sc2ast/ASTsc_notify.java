 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_notify.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_notify extends SimpleNode {
  public ASTsc_notify(int id) {
    super(id);
  }

  public ASTsc_notify(SCParser p, int id) {
    super(p, id);
  }
