 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTcontinue_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTcontinue_statement extends SimpleNode {
  public ASTcontinue_statement(int id) {
    super(id);
  }

  public ASTcontinue_statement(SCParser p, int id) {
    super(p, id);
  }
