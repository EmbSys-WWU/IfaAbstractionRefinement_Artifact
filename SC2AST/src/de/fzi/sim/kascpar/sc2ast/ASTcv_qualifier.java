 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTcv_qualifier.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTcv_qualifier extends SimpleNode {
  public ASTcv_qualifier(int id) {
    super(id);
  }

  public ASTcv_qualifier(SCParser p, int id) {
    super(p, id);
  }
