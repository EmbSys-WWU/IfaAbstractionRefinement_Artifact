 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnamed_namespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnamed_namespace_definition extends SimpleNode {
  public ASTnamed_namespace_definition(int id) {
    super(id);
  }

  public ASTnamed_namespace_definition(SCParser p, int id) {
    super(p, id);
  }
