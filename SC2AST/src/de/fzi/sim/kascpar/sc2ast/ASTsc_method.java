 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_method.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_method extends SimpleNode {
  public ASTsc_method(int id) {
    super(id);
  }

  public ASTsc_method(SCParser p, int id) {
    super(p, id);
  }
