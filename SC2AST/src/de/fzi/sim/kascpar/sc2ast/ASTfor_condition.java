 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTfor_condition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTfor_condition extends SimpleNode {
  public ASTfor_condition(int id) {
    super(id);
  }

  public ASTfor_condition(SCParser p, int id) {
    super(p, id);
  }
