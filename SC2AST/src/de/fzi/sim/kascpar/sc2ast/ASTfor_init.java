 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTfor_init.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTfor_init extends SimpleNode {
  public ASTfor_init(int id) {
    super(id);
  }

  public ASTfor_init(SCParser p, int id) {
    super(p, id);
  }
