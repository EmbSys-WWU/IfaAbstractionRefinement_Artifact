 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTempty_statement.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTempty_statement extends SimpleNode {
  public ASTempty_statement(int id) {
    super(id);
  }

  public ASTempty_statement(SCParser p, int id) {
    super(p, id);
  }
