 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTnamespace_definition.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTnamespace_definition extends SimpleNode {
  public ASTnamespace_definition(int id) {
    super(id);
  }

  public ASTnamespace_definition(SCParser p, int id) {
    super(p, id);
  }
