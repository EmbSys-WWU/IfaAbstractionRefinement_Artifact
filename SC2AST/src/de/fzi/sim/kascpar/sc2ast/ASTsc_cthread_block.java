 ...
 ****************************************************************************/
 /* Generated By:JJTree: Do not edit this line. ASTsc_cthread_block.java */

package de.fzi.sim.kascpar.sc2ast;

public class ASTsc_cthread_block extends SimpleNode {
  public ASTsc_cthread_block(int id) {
    super(id);
  }

  public ASTsc_cthread_block(SCParser p, int id) {
    super(p, id);
  }
