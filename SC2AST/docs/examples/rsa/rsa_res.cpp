...
{
  char p_str[ ( ( 250 / 2 ) + 2 ) + 1 ];

  rand_bitstr( p_str, ( ( 250 / 2 ) + 2 ) );
  p_str[ ( ( 250 / 2 ) + 2 ) - 1 ] = '1'; // Force p to be an odd number.
...
rsa( int seed )
{
  ...
  char r_str[ ( ( 250 / 2 ) + 2 ) + 1 ];

  max_bitstr( r_str, ( ( 250 / 2 ) + 2 ) );
  bigint r = r_str;
  ...
  char msg_str[ ( 250 + 2 ) + 1 ];
  rand_bitstr( msg_str, ( 250 + 2 ) );
  bigint msg = msg_str;
